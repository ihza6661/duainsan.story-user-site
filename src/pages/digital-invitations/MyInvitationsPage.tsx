  ...
  const handleShare = async (publicUrl: string, coupleName: string) => {
    ...
    if (navigator.share) {
      try {
        ...
        // Show success toast after share completed
        toast({
    ...
    <div className="min-h-screen bg-background py-20 sm:py-28">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Kelola undangan digital Anda</p>
        </div>
        ...
        {invitations && invitations.length > 0 ? (
            ...
            {invitations.map((invitation) => (
              <Card key={invitation.id} className="overflow-hidden">
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex items-center gap-2 text-sm">
                        <span className="font-medium">
                          {invitation.customization_data.bride_name ||
                            "Mempelai Wanita"}
                        </span>
                        <span>&</span>
                        <span className="font-medium">
                          {invitation.customization_data.groom_name ||
                            "Mempelai Pria"}
                        </span>
                      </div>
                ...
                <CardFooter className="gap-2 flex-col sm:flex-row">
                  <Link
                    to={`/my-invitations/${invitation.id}/edit`}
          ...
          <Card className=" container text-center py-12">
            <CardContent>

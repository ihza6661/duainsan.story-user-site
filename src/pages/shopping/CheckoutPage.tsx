...
const CheckoutPage = () => {
  ...
  useEffect(() => {
    ...
    setCalculatedWeight(
      typeof cart.total_weight === "number" ? cart.total_weight : null,
    );
      ...
      try {
        ...
        if (services.length === 0) {
          toast({
            ...
            description:
              "Tidak ada layanan pengiriman yang tersedia untuk kombinasi alamat dan courier ini.",
            variant: "destructive",
          });
        }
      } catch (error) {
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  {cart.items.map((item) => {
                    const getImageUrlForItem = () => {
                      ...
                      if (!imageToRender && item.variant?.images?.length > 0) {
                ...
                <div className="border-t border-border pt-4 space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(
                      value: "rajaongkir" | "pickup" | "gosend",
                    ) => {
                ...
                {shippingMethod === "gosend" && (
                  <div className="border-t border-border pt-4 space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Masukkan tarif GoSend dari aplikasi Gojek. Minimal Rp
                      5.000.
                    </p>
                  </div>
                )}
                  ...
                  <>
                    ...
                    <div className="border-t border-border pt-4 space-y-2">
                      ...
                      <Select
                        ...
                        disabled={
                          isCalculatingCost || shippingServices.length === 0
                        }
                      >
                        <SelectTrigger>
                          <SelectValue
